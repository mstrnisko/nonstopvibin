...
| Kimi Code                     | OAuth/device sign-in/import                                            | Usage and rate-limit windows                                  | Implemented from upstream/source formats; live verification pending                    |
| Antigravity                   | OAuth/import                                                           | Per-model quota buckets                                       | Implemented; parser tested; live verification pending                                  |
| Grok Build                    | OAuth/device sign-in/import                                            | Weekly credits and monthly billing windows                    | Implemented; parser tested; live verification pending                                  |
