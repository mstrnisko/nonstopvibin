...
and pi obtain keys through their native credential command support; OpenCode uses
an automatically loaded provider plugin. Both use an owner-only local Unix socket.
